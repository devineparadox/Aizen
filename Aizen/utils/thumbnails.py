...
async def gen_thumb(videoid: str):
    try:
        ...
        arial = ImageFont.truetype("Aizen/assets/font2.ttf", 30)
        font = ImageFont.truetype("Aizen/assets/font.ttf", 30)
        title_font = ImageFont.truetype("Aizen/assets/font3.ttf", 45)
        ...
        play_icons = Image.open("Aizen/assets/play_icons.png")
